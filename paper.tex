...
\begin{figure}%
    \centering
    \subfloat[Before migration]{{\includegraphics[width=3.2in]{pre-migration-state.png} }}%
    \qquad
    \subfloat[During migration]{{\includegraphics[width=3.2in]{in-migration-state.png} }}%
    \qquad
    \subfloat[After migration]{{\includegraphics[width=3.2in]{post-migration-state.png} }}%
