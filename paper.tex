...
\begin{figure}%
    \centering
    \subfloat[Original database schema]{{\includegraphics[width=2.6in]{pre-migration-state.png} }}%
    \qquad
    \subfloat[Database schema in mixed-state]{{\includegraphics[width=2.6in]{in-migration-state.png} }}%
    \qquad
    \subfloat[New database schema]{{\includegraphics[width=2.6in]{post-migration-state.png} }}%
